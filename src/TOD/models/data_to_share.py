...
df_aim_image = pyam.IamDataFrame(
    "./././data/TOD/model_results/to_share/IMAGE_and_AIM_to_share_UPDATED.xlsx"
)
df_fasst = pyam.IamDataFrame(
    "./././data/TOD/model_results/to_share/FASST_to_share.xlsx"
)
df_ifs = pyam.IamDataFrame("./././data/TOD/model_results/to_share/IFs_to_share.xlsx")
df_globio = pyam.IamDataFrame(
    "./././data/TOD/model_results/to_share/GLOBIO_to_share.xlsx"
)
df_gnm = pyam.IamDataFrame("./././data/TOD/model_results/to_share/GNM_to_share.xlsx")
df_gtem = pyam.IamDataFrame("./././data/TOD/model_results/to_share/GTEM_to_share.xlsx")
df_mimosa = pyam.IamDataFrame(
    "./././data/TOD/model_results/to_share/MIMOSA_to_share.xlsx"
)
df_gem = pyam.IamDataFrame("./././data/TOD/model_results/to_share/GEM_E3_to_share.xlsx")

df_gdp = pyam.IamDataFrame("./././data/TOD/model_results/to_share/GDP_to_share.xlsx")

# Chapter 19 specific data
df_19 = pd.read_excel("./././data/TOD/model_results/to_share/Chapter_19_to_share.xlsx")
df_19_gdp = pd.read_excel(
    "./././data/TOD/model_results/to_share/GDP_to_share_chapter_19.xlsx"
)
# df_19_gdp_mer = pd.read_excel(
#     "./././data/TOD/model_results/to_share/GDP_to_share_chapter_19_MER.xlsx"
# )
...
df_to_share_19 = pd.concat([df_19, df_19_gdp,
                            #df_19_gdp_mer
...
file_path = "./././data/TOD/model_results/to_share/model_results_to_share.xlsx"
file_path_19 = (
    "./././data/TOD/model_results/to_share/model_results_to_share_Chapter_19_June_2025.xlsx"
)
